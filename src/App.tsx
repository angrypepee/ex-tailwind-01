...
function App() {
  ...
  //menampilkan chore
  const toggleChoreCompletion = (index:number) => {
    setChores(
      chores.map((chore, i) => 
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 w-full max-w-md">
        ...
        <div className='flex mb-3'>
          <div className='items-end'>
            ...
            <div className='items-start'>
              <h1 className="text-xl font-bold mb-0 card text-left">Hai, Fellas!!</h1>
        ...
        {totalChores === 0 ? (
          <div className='flex flex-col items-center p-4'>
            <img src= {banner} width={200} alt='banner'/>
            <p className="text-gray-500 text-center mb-4">No tasks available. Please add a chore.</p>
          </div>
        ) : (
            <ul className="list-disc min-h-[200px]">
              {chores.map((chore, index) => (
                <li key={index} className="flex justify-between items-center mb-2 border rounded pr-2 pl-2 p-1">
                  <div className="flex items-center width-[40px]">
                    <input
                      type="checkbox"
                    ...
                    <div className='flex flex-col'>
                      <span className="text-gray-400 text-[7pt] text-base/1">
                  ...
                  >
                    {/* remove icon */}
                    <div className="border-2 rounded p-1 border-rose-500 ...">
        ...
        <div className="pt-4 items-start flex">
          <p>Add Todo</p>
        </div>
